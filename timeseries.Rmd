...
##Notes
We put a special effort in reporting the process of the selection of the ARIMA model as somewhat linear. This does not concide at all with the reality. The truth is that a lot of trial and error was involved in getting the results.

We purposedly left auto the usage of automatic techniques for ARIMA model selection, as it was outside the scope of the box-jenkins methodology.