...
#Introduction
This notebook was developed for the last assignment of the `Intelligent Data Analysis` course held by [Arminda Moreno Díaz](http://www.dia.fi.upm.es/es/amoreno) in UPM.
